...
const product = {
  ...
  description:
    'AirPods Pro (2nd generation) with MagSafe Charging Case (USB-C) deliver up to 2x more Active Noise Cancellation than the previous generation,¹ with Transparency mode that enables you to hear the world around you. All-new Adaptive Audio that dynamically tailors noise control to your environment.',
  highlights: [
  ...
  details:'Up to 6 hours of listening time with Active Noise Cancellation enabled.⁷ Up to 30 hours of total listening time with Active Noise Cancellation enabled, using the case.',
}
